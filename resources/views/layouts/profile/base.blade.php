...
<head>
    ...
    <!-- mobile settings -->
    <meta name="مشاهدهport" content="width=device-width, maximum-scale=1, initial-scale=1, user-scalable=0"/>

    <!-- WEB FONTS -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,700,800&amp;subset=latin,latin-ext,cyrillic,cyrillic-ext"
          rel="stylesheet" type="text/css"/>

    <link href="/backend/css/output.css" rel="stylesheet" type="text/css"/>
    @yield('style')
</head>
<!--
    .boxed = boxed version
...
<div id="wrapper" class="clearfix">
    ...
    <aside id="aside">
        ...
        -->
        @include('layouts.profile.partials.nav')
    ...
    <!-- HEADER -->
@include('layouts.profile.partials.header')
...
<!-- JAVASCRIPT FILES -->
<script type="text/javascript">var plugin_path = '/backend/plugins/';</script>
...
<script type="text/javascript">
    ...
    */
    ...
    @if(session()->has('flashMessage'))
            @include('partials.tostr', ['message'=>session()->pull('flashMessage')])
    @endif
